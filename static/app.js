...
const APPS = [
  ...
  { id: "pre1", tag: "PRE-1 / 過去問", label: "準1級モード", title: "英検準1級 過去問演習", skill: true, mount: () => EikenPre1App.mount(), handleKey: (e) => EikenPre1App.handleKey(e), startSerial: () => EikenPre1App.startCourse() },
...
function renderAppNav() {
  ...
  const visibleApps = APPS.filter((app) => {
    ...
    return currentPath === "free" && (profile && profile.grade === "pre1" ? app.id === "pre1" : app.id !== "pre1");
  });
